...
if(isset($_POST['submit'])){
	...
	$obj->edit_course($_POST['course-short'],$_POST['course-lastname'],$_POST['course-location'],$_POST['udate'],$id);
...
<form method="post" >
  ...
  <input class="form-control" name="course-lastname" id="clastname"  value="<?php echo $res->clastname;?>" required="required"  onblur="courseAvailability()">       
							<span id="course-availability-status" style="font-size:12px;"></span>				</div>
		...
		<div class="col-lg-6">
<input class="form-control" name="course-location" id="clocation" value="<?php echo $res->clocation;?>" required="required"  onblur="coursefullAvail()">         
