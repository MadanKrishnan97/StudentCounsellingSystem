...
if (! (isset ( $_SESSION ['login'] ))) {
  ...
  if(isset($_POST['submit'])){
	...
	$obj->create_subject($_POST['stud-firstname'],$_POST['stud-lastname'],$_POST['stud-phone'],$_POST['stud-email']);	
...
<form method="post" >
			...
			<option VALUE="">SELECT</option>
				<?php while($res=$rs->fetch_object()){?>							
					...
					<span id="course-availability-status" style="font-size:12px;"></span>	
								...
								<div class="col-lg-6">
								<input class="form-control" name="stud-firstname" id="sfirstname" required="required"  onblur="coursefullAvail()">         
	...
	<br><br>	-->
						...
						<div class="form-group">
							...
							<div class="col-lg-6">
							<input class="form-control" name="stud-lastname" id="slastname" required="required"  onblur="coursefullAvail()">         
							<span id="course-status" style="font-size:12px;"></span>				</div>
							</div>	
	...
	<div class="col-lg-6">
	<input class="form-control" name="stud-phone" id="sphone" required="required"  onblur="coursefullAvail()">         
	<span id="course-status" style="font-size:12px;"></span>				</div>
	</div>	
	 ...
	 <div class="col-lg-6">
	 <input class="form-control" name="stud-email" id="semail" required="required"  onblur="coursefullAvail()">         
	 <span id="course-status" style="font-size:12px;"></span>				</div>
	 </div>	
